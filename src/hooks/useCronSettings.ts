...
export function useTelegramChatIds() {
    return useQuery<{ chatIds: string[] }>({
...
export function useRefreshTelegramChatIds() {
    return useMutation<{ chatIds: string[] }>({
        mutationFn: async () => {
            throw new Error('Legacy telegram API routes no longer exist. Use UserBotSettingsSection instead.');
        },
    });
...
export function useSendTelegramTest() {
    return useMutation<{ subscriberCount: number }>({
        mutationFn: async () => {
            throw new Error('Legacy telegram API routes no longer exist. Use UserBotSettingsSection instead.');
        },
    });
...
export function useMigrateSubscribers() {
    return useMutation<{ success: boolean; migrated: number; skipped: number }, Error, number>({
        mutationFn: async (_botId: number) => {
