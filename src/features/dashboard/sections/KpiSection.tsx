...
export function KpiSection() {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <MetricCard
                title="Tổng chi tiêu"
                value={`${metrics.totalSpend.toLocaleString('vi-VN', { maximumFractionDigits: 0 })} ₫`}
            ...
            <MetricCard
                ...
                value={metrics.totalLeads.toLocaleString('vi-VN')}
                subtitle="Dữ liệu từ Ads Insights (30 ngày)"
                icon={Users}
                trend={{
            ...
            <MetricCard
                ...
                value={`${metrics.overallCPL.toLocaleString('vi-VN', { maximumFractionDigits: 0 })} ₫`}
            ...
            <MetricCard
                title="Tổng Clicks"
                value={metrics.totalClicks.toLocaleString('vi-VN')}
                subtitle={`CPC: ${(metrics.totalClicks > 0 ? metrics.totalSpend / metrics.totalClicks : 0).toLocaleString('vi-VN', { maximumFractionDigits: 0 })} ₫`}
                icon={MousePointer}
                trend={{
