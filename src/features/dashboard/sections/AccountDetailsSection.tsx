                                        ...
                                        return (
                                            <div key={campaign.id} className="py-4 flex items-center justify-between group hover:bg-slate-50/50 transition-colors rounded-lg px-2 -mx-2">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="font-medium text-sm line-clamp-1 max-w-[150px] md:max-w-[250px]">{campaign.name}</p>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <div className={`px-2 py-0.5 rounded-full text-[9px] font-bold border ${perfConfig.color}`}>
                                                        {perfConfig.label}
                                                    </div>
                                                    <div className={`hidden md:block px-1.5 py-0.5 rounded-md text-[8px] font-bold border uppercase ${
